...
//        var_dump(PHP_OS);
    ...
    { //freeBSD系统探测
        $res['cpu']['num'] = $this->do_command('sysctl', 'hw.ncpu');//CPU
        $res['cpu']['model'] = $this->do_command('sysctl', 'hw.model');
        $res['loadAvg'] = $this->do_command('sysctl', 'vm.loadavg');//Load AVG  系统负载
        //uptime
        $buf = $this->do_command('sysctl', 'kern.boottime');
        $buf = explode(' ', $buf);
...
<div id="page">
    ...
    <div class="con">
        ...
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">服务器域名/IP地址</label><label><?= $S->S['DomainIP']; ?></label></div>
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">服务器标识</label><label><?= $S->S['Flag']; ?></label></div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器操作系统</label>
                <label class
                       ="j_td"><?= $S->S['OS']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器解译引擎</label>
                <label class
                       ="j_td"><?= $S->S['WebEngine']; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器语言</label>
                <label class
                       ="j_td"><?= $S->S['Language']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器端口</label>
                <label class
                       ="j_td"><?= $S->S['WebPort']; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器主机名</label>
                <label class
                       ="j_td"><?= $S->S['Name']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">绝对路径</label>
                <label class
                       ="j_td"><?= $S->S['WebPath']; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">管理员邮箱</label>
                <label class
                       ="j_td"><?= $S->S['Email']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">探针路径</label>
                <label class
                       ="j_td"><?= $S->S['ProbePath']; ?></label></div>
        </div>
    </div>
    <!--Server Real-Time-->
    <div class
        ...
        <div class
            ...
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器当前时间</label>
                <label class
                       ="j_td" id="stime"><?= $S->S['sTime']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t">服务器已运行时间</label>
                <label class
                       ="j_td" id="uptime"><?= $S->sysInfo['uptime']; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">CPU型号[<?= $S->sysInfo['cpu']['num']; ?>
                核]</label><label><?= $S->sysInfo['cpu']['model']; ?></label></div>
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">CPU使用情况</label><label id="cpuuse"><?= $S->CPU_Use; ?></label></div>
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">硬盘使用状况</label>
        ...
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">内存使用状况</label>
            <label class
                   ="j_td">物理内存：共<font color='#CC0000'><?= $S->sysInfo['memTotal']; ?> </font>
        ...
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t">系统平均负载</label>
            <label class
                   ="j_td"><?= $S->sysInfo['loadAvg'] ?></label></div>
    </div>
    <!--net work-->
    <div class
         ="con">
    ...
    <div class
        ...
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t"><?= $S->phpexts(); ?></label></div>
    </div>
    <!--enbale module-->
    <a name="j_php"></a>
    <div class
        ...
        <div class
            ...
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PHP信息（phpinfo）：</label>
                <label class
                       ="j_td"><?= $disFuns; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PHP版本（php_version）：</label>
                <label class
                       ="j_td"><?= PHP_VERSION; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PHP运行方式：</label>
                <label class
                       ="j_td"><?= strtoupper(php_sapi_name()); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">脚本占用最大内存（memory_limit）：</label>
                <label class
                       ="j_td"><?= $S::show("memory_limit"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PHP安全模式（safe_mode）：</label>
                <label class
                       ="j_td"><?= $S::show("safe_mode"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">POST方法提交最大限制（post_max_size）：</label>
                <label class
                       ="j_td"><?= $S::show("post_max_size"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">上传文件最大限制（upload_max_filesize）：</label>
                <label class
                       ="j_td"><?= $S::show("upload_max_filesize"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">浮点型数据显示的有效位数（precision）：</label>
                <label class
                       ="j_td"><?= $S::show("precision"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">脚本超时时间（max_execution_time）：</label>
                <label class
                       ="j_td"><?= $S::show("max_execution_time"); ?>秒</label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">socket超时时间（default_socket_timeout）：</label>
                <label class
                       ="j_td"><?= $S::show("default_socket_timeout"); ?>秒</label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PHP页面根目录（doc_root）：</label>
                <label class
                       ="j_td"><?= $S::show("doc_root"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">用户根目录（user_dir）：</label>
                <label class
                       ="j_td"><?= $S::show("user_dir"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">dl()函数（enable_dl）：</label>
                <label class
                       ="j_td"><?= $S::show("enable_dl"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">指定包含文件目录（include_path）：</label>
                <label class
                       ="j_td"><?= $S::show("include_path"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">显示错误信息（display_errors）：</label>
                <label class
                       ="j_td"><?= $S::show("display_errors"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">自定义全局变量（register_globals）：</label>
                <label class
                       ="j_td"><?= $S::show("register_globals"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">数据反斜杠转义（magic_quotes_gpc）：</label>
                <label class
                       ="j_td"><?= $S::show("magic_quotes_gpc"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">"&lt;?...?&gt;"短标签（short_open_tag）：</label>
                <label class
                       ="j_td"><?= $S::show("short_open_tag"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">"&lt;% %&gt;"ASP风格标记（asp_tags）：</label>
                <label class
                       ="j_td"><?= $S::show("asp_tags"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">忽略重复错误信息（ignore_repeated_errors）：</label>
                <label class
                       ="j_td"><?= $S::show("ignore_repeated_errors"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">忽略重复的错误源（ignore_repeated_source）：</label>
                <label class
                       ="j_td"><?= $S::show("ignore_repeated_source"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">报告内存泄漏（report_memleaks）：</label>
                <label class
                       ="j_td"><?= $S::show("report_memleaks"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">自动字符串转义（magic_quotes_gpc）：</label>
                <label class
                       ="j_td"><?= $S::show("magic_quotes_gpc"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">外部字符串自动转义（magic_quotes_runtime）：</label>
                <label class
                       ="j_td"><?= $S::show("magic_quotes_runtime"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">打开远程文件（allow_url_fopen）：</label>
                <label class
                       ="j_td"><?= $S::show("allow_url_fopen"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">声明argv和argc变量（register_argc_argv）：</label>
                <label class
                       ="j_td"><?= $S::show("register_argc_argv"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Cookie 支持：</label>
                <label class
                       ="j_td"><?= $strcookies; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">拼写检查（ASpell Library）：</label>
                <label class
                       ="j_td"><?= $S::isfun("aspell_check_raw"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">高精度数学运算（BCMath）：</label>
                <label class
                       ="j_td"><?= $S::isfun("bcadd"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PREL相容语法（PCRE）：</label>
                <label class
                       ="j_td"><?= $S::isfun("preg_match"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">PDF文档支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("pdf_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SNMP网络管理协议：</label>
                <label class
                       ="j_td"><?= $S::isfun("snmpget"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">VMailMgr邮件处理：</label>
                <label class
                       ="j_td"><?= $S::isfun("vm_adduser"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Curl支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("curl_init"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SMTP支持：</label>
                <label class
                       ="j_td"><?= $strsmtp; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SMTP地址：</label>
                <label class
                       ="j_td"><?= $smtpadd; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <label class
                   ="j_td j_td_t1">默认支持函数（enable_functions）：</label>
            <label class
                   ="j_td"><a href='<?= $phpSelf; ?>?act=Function' target='_blank' class='static'>请点这里查看详细！</a></label>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">被禁用的函数（disable_functions）：</label>
                <label class
                       ="j_td"><?= $S::GetDisFuns(); ?></label></div>
        </div>
    </div>
    <!--组件支持-->
    <a name="j_module"></a>
    <div class
        ...
        <div class
            ...
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">FTP支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("ftp_login"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">XML解析支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("xml_set_object"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Session支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("session_start"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Socket支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("socket_accept"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Calendar支持</label>
                <label class
                       ="j_td"><?= $S::isfun('cal_days_in_month'); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">允许URL打开文件：</label>
                <label class
                       ="j_td"><?= $S::show("allow_url_fopen"); ?></label></div>
        </div>
        <div class
            ...
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">GD库支持：</label>
                <label class
                       ="j_td"><?= $S::GetGDVer(); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">压缩文件支持(Zlib)：</label>
                <label class
                       ="j_td"><?= $S::isfun("gzclose"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">IMAP电子邮件系统函数库：</label>
                <label class
                       ="j_td"><?= $S::isfun("imap_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">历法运算函数库：</label>
                <label class
                       ="j_td"><?= $S::isfun("JDToGregorian"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">正则表达式函数库：</label>
                <label class
                       ="j_td"><?= $S::isfun("preg_match"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">WDDX支持：</label>
                <label class
                       ="j_td"><?= $S::isfun("wddx_add_vars"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Iconv编码转换：</label>
                <label class
                       ="j_td"><?= $S::isfun("iconv"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">mbstring：</label>
                <label class
                       ="j_td"><?= $S::isfun("mb_eregi"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">高精度数学运算：</label>
                <label class
                       ="j_td"><?= $S::isfun("bcadd"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">LDAP目录协议：</label>
                <label class
                       ="j_td"><?= $S::isfun("ldap_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">MCrypt加密处理：</label>
                <label class
                       ="j_td"><?= $S::isfun("mcrypt_cbc"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">哈稀计算：</label>
                <label class
                       ="j_td"><?= $S::isfun("mhash_count"); ?></label></div>
        </div>
    </div>
    ...
    <div class
        ...
        <div class
             ="j_tb"><? $zendInfo = $S::GetZendInfo(); ?>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Zend版本</label>
                <label class
                       ="j_td"><?= $zendInfo['ver']; ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1"><?= $zendInfo['loader'] ?></label>
                <label class
                       ="j_td"><?= $zendInfo['html']; ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">eAccelerator</label>
                <label class
                       ="j_td"><?= $S->CHKModule('eAccelerator'); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">ioncube</label>
                <label class
                       ="j_td"><?= $S->GetIconcube(); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">XCache</label>
                <label class
                       ="j_td"><?= $S->CHKModule('XCache'); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">APC</label>
                <label class
                       ="j_td"><?= $S->CHKModule('APC'); ?></label></div>
        </div>
    </div>
    <a name="w_db"></a>
    <!--db-->
    <div class
        ...
        <div class
            ...
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">MySQL 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun('mysql_close') . $S::GetDBVer('mysql'); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">ODBC 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("odbc_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Oracle 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("ora_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SQL Server 数据库：</label>
                <label class
                       ="j_td"><? $S::isfun("mssql_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">dBASE 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("dbase_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">mSQL 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("msql_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SQLite 数据库：</label>
                <label class
                       ="j_td"><?= $S->GetDBVer('sqlite'); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Hyperwave 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("hw_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Postgre SQL 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("pg_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">Informix 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("ifx_close"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">DBA 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("dba_close"); ?></label></div>
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">DBM 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("dbmclose"); ?></label></div>
        </div>
        <div class
             ="j_tb">
            <div class
                 ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">FilePro 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("filepro_fieldcount"); ?></label></div>
            <div class ="j_td" style="width: 50%">
                <label class
                       ="j_td j_td_t1">SyBase 数据库：</label>
                <label class
                       ="j_td"><?= $S::isfun("sybase_close"); ?></label></div>
        </div>
    </div>
    <div class="con">
        <div align="center"><?php $run_time = sprintf('%0.4f', microtime_float() - $time_start); ?>Processed
            in <?php echo $run_time ?>
            seconds. <?php echo memory_usage(); ?> memory usage.
        </div>
    </div>
</div>
